...
type Server struct {
	...
	Capacity   int `orm:"column(capacity)" description:"单服最大创建角色数量"`
	ShowStatus int `orm:"column(show_status)" description:"状态，仅仅用于显示的flag：0-关服，1-开服正常，2-维护"`
	RealStatus int `orm:"column(real_status)" description:"状态，实际状态，增加3-测试，4-提审等"`
}
